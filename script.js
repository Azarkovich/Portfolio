...
const projectsData = [
    {
        title: "Mad Barber - Secure API",
        date: "2026-07-20", 
        team: "blue",
        teamLabel: "[ AppSec / Web ]",
        tags: ["FastAPI", "Python", "JWT", "AppSec"],
        description: "Secure appointment scheduling app built for an independent barber. Features Argon2id, JWT auth, strict rate limiting, and HTTP security headers.",
        description_fr: "Application de réservation sécurisée. Intègre un hachage Argon2id, authentification JWT, limitation de requêtes (rate limiting) et en-têtes de sécurité HTTP.",
        link: "viewer.html?file=mad-barber.md",
        linkText: "Read Write-up",
        linkText_fr: "Lire le Write-up",
        linkType: "wu"
    },
    {
        title: "PurpleKEY",
