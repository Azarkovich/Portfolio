...
const projectsData = [
    {
        ...
        desc_en: "Secure appointment scheduling app built for an independent barber. Features Argon2id, JWT auth, strict rate limiting, and HTTP security headers.",
        desc_fr: "Application de réservation sécurisée. Intègre un hachage Argon2id, authentification JWT, limitation de requêtes (rate limiting) et en-têtes de sécurité HTTP.",
